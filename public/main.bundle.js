...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_angular2_flash_messages__ = __webpack_require__(132);
...
var LoginComponent = (function () {
    function LoginComponent(flashMesage, authService, router) {
        this.flashMesage = flashMesage;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticatceUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMesage.show(user.username + ' was authenticate successfully', { cssClass: 'alert-success', timeout: 5000 });
                _this.authService.storeUserData(data.token, data.user);
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMesage.show(data.msg, { cssClass: 'alert-danger', timeout: 5000 });
                return false;
            }
        });
    };
...
var NavbarComponent = (function () {
    function NavbarComponent(flashMesage, authService, router) {
        this.flashMesage = flashMesage;
        this.authService = authService;
        this.router = router;
    }
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flashMesage.show('Logged out successfully', { cssClass: 'alert-success', timeout: 3000 });
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, flashMesage, authService, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMesage.show(user.username + ' was created successfully', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMesage.show('Failed to create User', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthService = (function () {
    ...
    AuthService.prototype.authenticatceUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Conetnt-Type', 'application/json');
